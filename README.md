...
Create your own private pivx testnet

You must have `pivxd` and `pivx-cli` installed on your system and in the
...
Normally on the live, real, pivx network, blocks are generated, on average,
every 10 minutes. Since this testnet-in-box uses Bitcoin Core's (pivxd)
...
## Sending pivxs
To send pivxs that you've generated to the second wallet: (be sure to change the ADDRESS value below to wallet address generated in the prior command)
